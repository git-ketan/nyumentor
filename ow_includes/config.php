...
define('OW_URL_HOME', 'http://127.0.0.1/nyumentor/');
define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'mentor');
define('OW_DB_PASSWORD', '3(P)M5r9SM');
define('OW_DB_NAME', 'mentor');
...
define('OW_PASSWORD_SALT', '551c5a5d7a317');
